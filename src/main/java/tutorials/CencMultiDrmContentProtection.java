 ...
 * </ol>
 */
public class CencMultiDrmContentProtection {
    private static final Logger logger = LoggerFactory.getLogger(CencMultiDrmContentProtection.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        Stream videoStream1 =
                createStream(encoding, input, configProvider.getHttpInputFilePath(), createH264VideoConfig(480, 800_000L));
        Fmp4Muxing videoMuxing1 = createFmp4Muxing(encoding, videoStream1);
        createDrmConfigSD(encoding, videoMuxing1, output, "video/1");



        Stream videoStream2 =
                createStream(encoding, input, configProvider.getHttpInputFilePath(), createH264VideoConfig(720, 1_200_000L));
        Fmp4Muxing videoMuxing2 = createFmp4Muxing(encoding, videoStream2);
        createDrmConfigHD(encoding, videoMuxing2, output, "video/2");
        ...
        Fmp4Muxing audioMuxing1 = createFmp4Muxing(encoding, audioStream1);
        createDrmConfigSD(encoding, audioMuxing1, output, "audio");
    ...
    private static CencDrm createDrmConfigHD(
            Encoding encoding, Muxing muxing, Output output, String outputPath) throws BitmovinException {
        CencDrm cencDrm = new CencDrm();
        cencDrm.addOutputsItem(buildEncodingOutput(output, outputPath));
        cencDrm.setKey("d1f2e0820bce91e982581f8dfc211519");
        cencDrm.setKid("286009f3062ee72d1dbddfc551525a8a");

        CencWidevine widevineDrm = new CencWidevine();
        widevineDrm.setPssh("CAESEPAgAGYk+pU2x7jqDx1L8LcSEChgCfMGLuctHb3fxVFSWooaDGlua2FlbnR3b3JrcyIIcGFsbXVsdGk=");
        cencDrm.setWidevine(widevineDrm);
    ...
    private static CencDrm createDrmConfigSD(
            Encoding encoding, Muxing muxing, Output output, String outputPath) throws BitmovinException {
        CencDrm cencDrm = new CencDrm();
        cencDrm.addOutputsItem(buildEncodingOutput(output, outputPath));
        cencDrm.setKey("a914d2631103c59f11b646fb6ce2b432");
        cencDrm.setKid("f020006624fa9536c7b8ea0f1d4bf0b7");
    ...
    public static String buildAbsolutePath(String relativePath) {
        String className = CencMultiDrmContentProtection.class.getSimpleName();
